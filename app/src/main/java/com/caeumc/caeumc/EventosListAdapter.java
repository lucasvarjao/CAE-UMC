 ...
 */
class EventosListAdapter extends BaseAdapter {
    private final List<EventosListModel> data = new ArrayList<>();
    private final TreeSet<Integer> sectionHeader = new TreeSet<>();
    private final TreeSet<Integer> semanasHeader = new TreeSet<>();
    ...
    public EventosListAdapter (Context context) {
        //  data = items;
